...
export const metadata: Metadata = {
  title: "Conditions d'Utilisation - SiteKept",
  description: "Conditions d'utilisation des services SiteKept. Consultez nos termes et conditions pour l'utilisation de nos services de développement web.",
};
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          <div className="prose prose-slate max-w-none">
            ...
            <p className="text-slate-600 mb-6">
              En accédant et en utilisant les services de SiteKept, vous acceptez d&apos;être lié par ces conditions d&apos;utilisation. 
              Si vous n&apos;acceptez pas ces conditions, veuillez ne pas utiliser nos services.
            </p>

            <h2 className="text-2xl font-bold text-slate-900 mb-4">2. Description des Services</h2>
            ...
            <h2 className="text-2xl font-bold text-slate-900 mb-4">3. Obligations du Client</h2>
            <p className="text-slate-600 mb-4">Le client s&apos;engage à :</p>
            <ul className="list-disc pl-6 text-slate-600 mb-6">
              ...
              <li>Ne pas reproduire ou revendre nos créations sans autorisation</li>
            </ul>

            <h2 className="text-2xl font-bold text-slate-900 mb-4">4. Propriété Intellectuelle</h2>
            <p className="text-slate-600 mb-6">
              Une fois le paiement intégral effectué, le client devient propriétaire du site web livré. 
              Cependant, SiteKept conserve les droits sur ses méthodes, processus et outils de développement. 
              Le code source peut être fourni selon les termes du contrat spécifique.
            </p>

            <h2 className="text-2xl font-bold text-slate-900 mb-4">5. Tarifs et Paiements</h2>
            <p className="text-slate-600 mb-4">
              Les tarifs sont établis selon la complexité du projet. Les modalités de paiement incluent :
            </p>
            <ul className="list-disc pl-6 text-slate-600 mb-6">
            ...
            <p className="text-slate-600 mb-6">
              ...
              retard dans la fourniture des éléments par le client, modifications importantes du cahier des charges,
              ou circonstances exceptionnelles indépendantes de notre volonté.
            </p>

            <h2 className="text-2xl font-bold text-slate-900 mb-4">7. Garanties et Support</h2>
            <p className="text-slate-600 mb-6">
              Nous garantissons le bon fonctionnement du site pendant 30 jours après la livraison. 
              Le support technique est inclus pour corriger les bugs et dysfonctionnements. 
              Les modifications de contenu ou de design font l&apos;objet d&apos;un devis séparé.
            </p>

            <h2 className="text-2xl font-bold text-slate-900 mb-4">8. Limitation de Responsabilité</h2>
            <p className="text-slate-600 mb-6">
              SiteKept ne peut être tenu responsable des dommages indirects, pertes de profits, 
              ou interruptions d&apos;activité. Notre responsabilité est limitée au montant des sommes versées 
            ...
            <p className="text-slate-600 mb-6">
              ...
              En cas de résiliation, les sommes déjà versées restent acquises pour les travaux réalisés.
            </p>
            ...
            <p className="text-slate-600 mb-6">
              SiteKept se réserve le droit de modifier ces conditions à tout moment. 
              Les modifications prendront effet dès leur publication sur notre site web.
            </p>
            ...
            <div className="bg-slate-50 p-6 rounded-lg">
              ...
              <p className="text-slate-600"><strong>Téléphone :</strong> +33 6 51 17 99 25</p>
            </div>
          </div>
        </div>
      </section>
