      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-2">
          {cards.map((card, index) => (
            <Card
              key={card.id}
              className="rounded-md border border-blue-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
              <CardContent className="p-6 sm:p-8">
                <span className="inline-flex rounded-sm border border-blue-100 bg-blue-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.24em] text-blue-700">
                  {card.eyebrow}
                </span>
